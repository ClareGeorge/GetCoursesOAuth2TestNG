...
public class PositiveAndNegative_6 extends EcomUtils_4   {
  ...
  @Test(dataProvider = "getTokenAPITestData",  groups = {"Regression"})
  public void callGetTokenAPINegative(ArrayList<String> eachRow) throws FileNotFoundException, IOException {
  ...
  @Test(dataProvider = "getTokenAPITestData")
  public void callGetTokenAPIPositive(ArrayList<String> eachRow) throws FileNotFoundException, IOException {
  ...
  @DataProvider(name = "getTokenAPITestData")
	public Iterator<List<String>> createExcelData(Method m) throws IOException {
